...
The previous 2 problems showed you how to create what we call a Taylor polynomial expanded about $c=0$ and $c=1$. The third  degree Taylor polynomial expanded about $c=0$ is in general given by \marginpar{The factorial function $n!$ for a natural number $n$ is defined  as the product of all the integers upto and including $n$, namely $n!=1\cdot 2\cdot 3 \cdots n$. We define $0!=1$.}
...
\begin{problem}\marginpar{See section 5.2, problems 1-24 for a review of sigma notation.}%
