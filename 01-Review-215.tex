...
\begin{problem}
\marginpar{See sections 3.2-3.6 for more practice with derivatives. The later problems in 3.6 review of most of the entire differentiation chapter.}
...
\begin{problem}
\marginpar{See sections 3.7-3.9 for more examples involving inverse trig functions and implicit differentiation.}
...
\begin{problem}
\marginpar{For practice with $u$-substitution, see section 5.5 and 5.6.  \\ For practice with integration by parts, see section 8.1.}
...
\begin{problem}\marginpar{See 3.10:19-38.}
...
\begin{problem} \label{differentials give tangent lines}\marginpar{See 3.11:39-44. Also see problems 3.11:1-18.  The linearization of a function is just an equation of the tangent line where you solve for $y$.}
...
\begin{problem} \marginpar{See 3.11:45-62.} \label{diff-sphere}
...
\begin{problem} \marginpar{For extra practice, make up two small matrices and multiply them.  Use Wolfram Alpha to see if you are correct. Follow the 
\href{http://www.wolframalpha.com/input/?i=\%281\%2C3\%2C4\%29+*\%28\%287\%2C2\%29\%2C\%281\%2C3\%29\%2C\%28-2\%2C0\%29\%29}{link} for an example of the notation.}
