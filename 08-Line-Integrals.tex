...
Make sure to ask me in class about the ``ant farm'' approach to average value. \note{I talk about ants building a mound. Then after removing the ants, so none get hurt, you shake their tank.  The average value is the height of the dirt. The mountains filled in the valleys.}
...
\end{problem}
\note{I like to take this time to emphasize that they should have noticed a linear growth rate, and then I show them how I would have guessed the answer.}
...
\end{enumerate}
\end{problem}
\note{I purposefully put this problem in to show students how to generalize a formula from prime numbers to any number.  I mention how I use primes (5, 7, 11, 13) when I'm looking for a pattern.  I want to help them develop this skill a little. I've got a hidden motive.}
