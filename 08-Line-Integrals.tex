...
\note{Change the function f to one they are more familiar with.  Perhaps use an ellipse (2\sin t, 3 \cos t) and f=9-x^2-y^2. Then you can put a reference to the horse problem.}%
\begin{problem}%
...
The area of the first rectangle is \marginpar{We'll use $\sigma$ to stand for surface area.} 
