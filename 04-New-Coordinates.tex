...
\begin{problem} \marginparbmw{See page 893.}\marginparlarsonfive{See Larson 11.7.}
...
\begin{problem}  \marginparbmw{See page 897.}\marginparlarsonfive{See Larson 11.7.} \label{derive spherical coordinates}
