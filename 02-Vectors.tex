...
\marginpar{By tomorrow, I should have homework links to the problems below.  For now, please begin on the problems.}
...
\begin{problem}\marginpar{See 12.1:41-58}
...
\begin{problem}\marginpar{See 12.1:1-40}
...
\begin{problem}\marginpar{See 12.2:23-24}
...
\begin{problem}\marginpar{See 11.1: 3,4.}
...
\begin{problem}\label{horse line}\marginpar{See 12.2: 1.}
...
\begin{problem}\marginpar{See 12.2: 9,17,25,33 and surrounding.}
...
\begin{problem}\marginpar{See 12.5: 1-12.}
...
\begin{problem}\marginpar{See 12.5: 13-20.}\label{first line between two points}%
Let $P=(3,1)$ and $Q=(-1,4)$.  
\begin{itemize}
...
\begin{problem}\label{dot prep} \marginpar{Page 693 has the solution if you are struggling.}
...
\begin{problem} \marginpar{See 12.3: 9-12.}
...
\begin{problem}  \marginpar{See page 693.}
...
\begin{problem} \marginpar{See page 694.}
...
\begin{definition}
The projection of $\vec F$ onto $\vec d$, written $\text{proj}_{\vec d}\vec F$, is defined as $$\text{proj}_{\vec d}\vec F = \left(\frac{\vec F\cdot \vec d}{\vec d\cdot \vec d}\right)\vec d.$$
\end{definition}

\begin{problem} \marginpar{See 12.3:1-8 (part d).}
Let $\vec u=(-1,2)$ and $\vec v=(3,4)$. Draw $\vec u,$ $\vec v$, and $\text{proj}_{\vec v}\vec u$. Then draw a line segment from the head of $\vec u$ to the head of the projection.

Now let $\vec u=(-2,0)$ and keep $\vec v=(3,4)$. Draw $\vec u,$ $\vec v$, and $\text{proj}_{\vec v}\vec u$. Then draw a line segment from the head of $\vec u$ to the head of the projection.
...
\begin{problem} \marginpar{See 12.3: 24, 41-44.}\label{first work problem}
...
\begin{problem}  \marginpar{See 12.4: 1-8.}
...
\begin{problem}  \marginpar{See 12.4: 15-18.}
...
\begin{problem} \marginpar{See 12.3: 9-14.}
Consider the vectors ${\bf i}$, ${2\bf j}$, and ${3\bf k}$ (so $(1,0,0)$, $(0,2,0)$, and $(0,0,3)$).  
\begin{itemize}
\item Compute ${\bf i}\times {2\bf j}$ and ${2\bf j}\times {\bf i}$.
\item Compute ${\bf i}\times {3\bf k}$ and ${3\bf k}\times {\bf i}$.
\item Compute ${2\bf j}\times {3\bf k}$ and ${3\bf k}\times {2\bf j}$.
\end{itemize}
...
\begin{problem}\marginpar{See page 709.}
...
\begin{problem}  \marginpar{See 12.5: 21-28.}
...
\begin{problem}  \marginpar{See 12.5: 57-60.}
