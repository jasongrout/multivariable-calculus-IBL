...
\begin{problem}\marginpar{\bens{See 14.2: 1-30 for more practice.}}%
...
$\ds\lim_{\text{\footnotesize $\begin{array}{c}(x,y)\to(0,0)\\ x=0\end{array}$}}\frac{x^2-y^2}{x^2-y^2}$.
 ...
 \item Does this function have a limit at $(0,0)$? Explain. \marginpar{\bens{See 14.2: 41-50 for more practice.}}%
\end{enumerate}
\hrule\end{problem}
...
\begin{problem}\marginpar{\bens{See 14.2: 41-50 for more practice.}}%
...
\begin{problem}\marginpar{\bens{See 14.3: 1-40 for more practice.} I strongly suggest you practice a lot of this type of problem until you can compute partial derivatives with ease.}%
...
\begin{problem} \label{cake plane introduction}\marginpar{\bens{See 14.6: 9-12 for more practice.}}%
...
\begin{problem}\marginpar{\bens{See 16.5: 27-30 for more practice.}}%
...
\begin{problem}\marginpar{\bens{See 14.6: 9-12 for more practice.}}%
...
\begin{problem}\label{general tangent plane with partials}\marginpar{\bens{Page 811 has the answer, but written in a slightly different form than you will get. In addition, they arrive at the solution in a completely different way.} }%%
...
\begin{problem}\marginpar{\bens{See 14.4: 1-6 for more practice.}}%
...
\begin{problem}\marginpar{\bens{See 14.4: 7-12 for more practice.}}%
...
\begin{problem}\marginpar{\bens{See 14.4: 13-24 for more practice.}  Don't use the ``branch diagram'' in the book---use matrix multiplication instead. The branch diagram is just a way to express matrix multiplication without having to introduce matrices.}%
...
\begin{problem}\marginpar{\bens{See 14.4: 25-32 to practice using the formula you developed.}  To practice the idea developed in this problem, show that if $w=F(x,y,z)$ is held constant at $w=c$ and we assume that $z=f(x,y)$ depends on $x$ and $y$, then $\frac{\partial z}{\partial x} = -\frac{F_x}{F_z}$ and $\frac{\partial z}{\partial y} = -\frac{F_y}{F_z}$. \bens{This is done on page 798 at the bottom. }}%
