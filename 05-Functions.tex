...
\marginpar{See \href{http://aleph.sagemath.org/?z=eJwrsS1LLNJQL1HX5CpILErMTS0pykyOL8jJL9GINtJKzi_WKNHUUTDWKs7MA7JidRQ0SnQMdIy0CjI1NQFWdRJT}{Sage} or \href{http://wolfr.am/wAkR8l}{Wolfram Alpha}.%http://www.wolframalpha.com/input/?i=parametric+plot+%282+cos+t,+3+sin+t%29
 \bens{There's a lot more practice of this idea in 11.1. Chapter 3 of the problem set was devoted to this idea. You'll also find more practice in 13.1: 1-8.}}%
...
\marginpar{See \href{http://aleph.sagemath.org/?z=eJwNxksKgCAUBdB5q3Dmh2eQfWZuJXmIgpAodtt_Dg6crKC92g1IXIfdLoPb6aXz4JowSgz9aVCZhAJZt540aRL89hQRBqM0L_lDq7NR6h-iAhhm}{Sage} or \href{http://wolfr.am/ynm3kD}{Wolfram Alpha}.%http://www.wolframalpha.com/input/?i=parametric+plot+%283t,+64-16t^2%29
 \bens{The text has more practice in 13.1: 1-8.}}%
...
\bens{The text has more practice in 13.1: 9-14.}}%
...
\begin{problem}
\marginpar{\bens{The text has more practice in 13.1: 19-22.}}
...
\begin{enumerate}
 \item What is the temperature at $(0,0)$, $(1,2)$, and $(-4,3)$? \marginpar{\bens{See 14.1: 1-4.}}
 ...
 \item Describe the shape. Add any extra features to your graph to convey the 3D image you are constructing. \marginpar{\bens{See 14.1: 37-48.}}
\end{enumerate}
\hrule\end{problem}
...
\href{http://wolfr.am/wny0IF}{Wolfram Alpha}.%http://www.wolframalpha.com/input/?i=plot+3d+9-x^2-y^2
 ...
 \begin{enumerate}
  \item%
\marginpar{\bens{See 14.1: 13-16 and 31-36.}}%
Which points in the plane have zero temperature? Just let $z=0$ in $z=9-x^2-y^2$. Plot the corresponding points in the $xy$-plane, and write $z=0$ next to this curve. This curve is called a level curve. As long as you stay on this curve, your temperature will remain level, it will not increase nor decrease. 
  ...
  \item Repeat the above for $z=8$, $z=9$, and $z=1$. What's wrong with letting $z=10$? \marginpar{\bens{See 14.1: 37-48.}}
...
\marginpar{See \href{http://aleph.sagemath.org/?z=eJxL06jQqdS0rdCtjDPiKsjJLzFO0UjTUQCK6hrrGGsCWZUQliYAA3IK2A}{Sage} or 
\href{http://wolfr.am/wBOk1b}{Wolfram Alpha}.%http://www.wolframalpha.com/input/?i=plot+3d+x-y^2
\bens{More practice is in 14.1: 37-48.}}%
...
\bens{You can access more problems on drawing level surfaces in 12.6:1-44 or 14.1:53-60.}}%
...
\begin{problem}\marginpar{See \href{http://aleph.sagemath.org/?z=eJwrSyzSUK_QqdSpUtfkStMAszRtK-KMdCvjjLSr4oy4MnMLcjKTM0viC3LyS4xTNOCKbA11FIBsBV1jHQVjTSC7EswGM6ugTE0FAIXAGhM}{Sage}.  \bens{Remember you can find more practice in 12.6:1-44 or 14.1: 53-64.}}%
...
The computer will shrink the largest vector down in size so it does not overlap any of the others, and then reduce the size of all the vectors accordingly. \bens{See 16.2: 39-44 for more practice.}}%
...
\begin{problem}[Spin field]\marginpar{Use the links above to see the computer plot this.  \bens{See 16.2: 39-44 for more practice.}}%
...
\marginpar{Use \href{http://aleph.sagemath.org/?z=eJxz06jQqdSp0lSwVdAA0joVmlwFOfkl8WWpySX5RfFpmak5KcYpGm46CkCFusY6xpo6IIUQlkYVhKEJAOGFExs}{Sage} to plot your vector fields.  \bens{See 16.2: 39-44 for more practice.}}%
Do the following:
\begin{enumerate}
...
to plot your parametrization.  \bens{See 16.5: 1-16 for more practice.}}
...
\hrule\end{problem}
\begin{problem}%
\marginpar{Use \href{http://aleph.sagemath.org}{Sage} or \href{http://wolframalpha.com}{Wolfram Alpha} to plot your parametrization with your bounds (see \ref{3d parametric plot} for examples).  \bens{See 16.5: 1-16 for more practice.}}%
...
\begin{problem}%
\marginpar{\bens{See 16.5: 1-16 for more practice.}}
