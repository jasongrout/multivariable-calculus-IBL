...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=f\%28t\%29\%3D64-16t^2}{Wolfram Alpha}. Follow the links to Wolfram Alpha in all the problems below to see how to get the computer to graph the function.}%
...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+\%282+cos+t\%2C+3+sin+t\%29}{Wolfram Alpha}. There's a lot more practice of this idea in 11.1. Chapter 3 of the problem set was devoted to this idea. You'll also find mor practice in 13.1: 1-8.}%
...
\begin{problem}%
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+\%283t\%2C+64-16t^2\%29}{Wolfram Alpha}. The text has more practice in 13.1: 1-8.}%
...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+3D++\%282+cos+t\%2C+2+sin+t\%2C+t\%29+for+t+from+0+to+4+pi}{Wolfram Alpha}. 
The text has more practice in 13.1: 9-14.}%
...
In all the problems above, you should have noticed that in order to draw a function (provided you include arrows for direction) you can determine how many dimensions you need to graph a function by just summing the dimension of the domain and target space. This is true in general.

\begin{problem}
\marginpar{The text has more practice in 13.1: 19-22.}
...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+3D++\%28a+cos+t\%2C+a+sin+t\%2C+t\%29+for+t+from+0+to+4+pi+and+a+from+2+to+4}{Wolfram Alpha}.}%
...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+3d+\%28u+cos+v\%2C+u+sin+v\%2C+u^2\%29}{Wolfram Alpha}.}% 
...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=plot+3d+9-x^2-y^2}{Wolfram Alpha}.
}%
...
\begin{enumerate}
 \item What is the temperature at $(0,0)$, $(1,2)$, and $(-4,3)$? \marginpar{See 14.1: 1-4.}
 ...
 \item Describe the shape. Add any extra features to your graph to convey the 3D image you are constructing. \marginpar{See 14.1: 37-48.}
\end{enumerate}
\end{problem}
...
\marginpar{See \href{http://www.wolframalpha.com/input/?i=plot+3d+9-x^2-y^2}{Wolfram Alpha}.}%
 ...
 \begin{enumerate}
  \item%
\marginpar{See 14.1: 13-16 and 31-36.}%
Which points in the plane have zero temperature? Just let $z=0$ in $z=9-x^2-y^2$. Plot the corresponding points in the $xy$-plane, and write $z=0$ next to this curve. This curve is called a level curve. As long as you stay on this curve, your temperature will remain level, it will not increase nor decrease. 
  ...
  \item Repeat the above for $z=8$, $z=9$, and $z=1$. What's wrong with letting $z=10$? \marginpar{See 14.1: 37-48.}
...
\begin{problem}%
\marginpar{See \href{http://www.wolframalpha.com/input/?i=plot+3d+x-y^2}{Wolfram Alpha}. More practice is in 14.1: 37-48.}%
...
\begin{problem}%
\marginpar{Wolfram Alpha currently does not support drawing level surfaces.  You can use 
\begin{itemize}
 \item Mathematica (see Brainhoney for details),
 \item \href{http://www.sagenb.org/home/pub/4203}{SAGE at sagemath.org}, or 
 \item \href{http://demonstrations.wolfram.com/LevelSurfacesAndQuadraticSurfaces/}{Wolfram Demonstrations}.
\end{itemize}
Just follow the links above.

You can access more problems on drawing level surfaces in 12.6:1-44 or 14.1:53-60.}%
...
\begin{problem}\marginpar{Remember you can find more practice in 12.6:1-44, or 14.1: 53-64.}%
...
\begin{problem}%
\marginpar{Recall that $\rho$ is the angle down from the $z$ axis, and theta is the angle counterclockwise from the $x$-axis in the $xy$-plane. Review problem \ref{derive spherical coordinates} if you need a refresher.}%
...
\begin{enumerate}
 \item% 
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+3d+\%282+sin+phi+cos+theta\%2C+2+sin+phi+sin+theta\%2C+2+cos+phi\%29}{Wolfram Alpha}.}%
Let $\rho=2$ and graph the resulting surface.  What do you get if $\rho = 3$?
 \item % 
\marginpar{See \href{http://www.wolframalpha.com/input/?i=parametric+plot+3d+\%28rho+sin+\%28pi\%2F4\%29+cos+theta\%2C+rho+sin+\%28pi\%2F4\%29+sin+theta\%2C+rho+cos+\%28pi\%2F4\%29\%29+}{Wolfram Alpha}.}%
...
\begin{problem}%
\marginpar{See \href{http://www.wolframalpha.com/input/?i=plot+a+vector+field&f1={2x\%2By\%2Cx\%2B2y}&x=10&y=8&f=VectorPlot.vectorfunction_{2x\%2By\%2Cx\%2B2y}&f2=x&f=VectorPlot.vectorplotvariable1_x&f3=-10&f=VectorPlot.vectorplotlowerrange1_-10&f4=10&f=VectorPlot.vectorplotupperrange1_10&f5=y&f=VectorPlot.vectorplotvariable2_y&f6=-10&f=VectorPlot.vectorplotlowerrange2_-10&f7=10&f=VectorPlot.vectorplotupperrange2_10}{Wolfram Alpha} for a generic tool to graph any vector field in the plane. The computer will shrink the largest vector down in size so it does not overlap any of the others, and then reduce the size of all the vectors accordingly. See 16.2: 39-44 for more practice.}%
...
\begin{problem}[Spin field]\marginpar{Here's another link to the vector field plotter in \href{http://www.wolframalpha.com/input/?i=plot+a+vector+field}{Wolfram Alpha}. See 16.2: 39-44 for more practice.}%
...
\begin{enumerate}
 \item% 
\marginpar{See 16.2: 39-44 for more practice.}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{Idea.  They did this above already when drawing spherical coordinates.  They already practiced removing a variable.  I somehow need to make that connect to this part. How to do it, I'm not sure. Think about it, and try something different next time.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{problem}%
\marginpar{See 16.5: 1-16 for more practice.}%
 Consider the surface $z=9-x^2-y^2$ plotted in problem \ref{surface graph for a function of two variables}.
\begin{enumerate}
 \item \marginpar{Use \href{http://www.wolframalpha.com/}{Wolfram Alpha} to plot your parametrization. Just remember the command ``parametric plot 3d.''}%
...
\begin{enumerate}
 \item \marginpar{Use \href{http://www.wolframalpha.com/}{Wolfram Alpha} to plot your parametrization.}%
...
Give a parametrization of the sphere of radius 2, using $\phi$ and $\theta$ as your input variables. 
 ...
 \item% 
\marginpar{Use \href{http://www.wolframalpha.com/}{Wolfram Alpha} to plot your parametrization with the bounds you chose.}%
...
\begin{enumerate}
 \item\marginpar{Use \href{http://www.wolframalpha.com/}{Wolfram Alpha} to plot each parametrization with your bounds. Just remember the command ``parametric plot 3d.''}%
