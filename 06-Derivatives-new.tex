...
3\\  2t
\end{bmatrix}.$
In first semester calculus, the chain rule was the product of derivatives. Show that this works in higher dimensions by multiplying matrices and showing $$\dfrac{dV}{dt}=DV(g(t))\, Dg(t).$$ 
