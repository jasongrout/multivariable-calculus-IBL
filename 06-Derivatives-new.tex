...
\begin{enumerate}
 \item  The parametric surface $\vec r(u,v) = (u,v,u\cos(v))$. [Hint: compute partial derivatives $\vec r_u$, $\vec r_v$ and the total derivative $D\vec r(u,v)$ (a 3-row by 2-column matrix)].
...
\begin{enumerate}
 ...
 \item \marginpar{Please see \href{https://sagecell.sagemath.org/?z=eJxL0yjRUUjUtNVI1ErOL9Yo0QTytIoz88CsEk2ugsSixNzUkqLM5PiCnPwSjTQdBaAOAx0FE62CTKASjUQdBSMgT1OTCwBCiRSf}{Sage} or \href{http://www.wolframalpha.com/input/?i=parametric+plot+3D++\%28a+cos+t\%2C+a+sin+t\%2C+t\%29+for+t+from+0+to+4+pi+and+a+from+2+to+4}{Wolfram Alpha} for a plot of the surface. Click on either link.}%
